...
- [Provider development](docs/contributing/README.md)
...
To contribute, please read the contribution guidelines: [Contributing to Terraform - AWS Provider](docs/contributing/README.md)

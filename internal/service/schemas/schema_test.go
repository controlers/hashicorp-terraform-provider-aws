...
func TestAccAWSSchemasSchema_ContentDescription(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSchemaContentDescriptionConfig(rName, testAccAWSSchemasSchemaContent, "description1"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSchemasSchemaExists(resourceName, &v),
			...
			{
				Config: testAccSchemaContentDescriptionConfig(rName, testAccAWSSchemasSchemaContentUpdated, "description2"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSchemasSchemaExists(resourceName, &v),
